    ...
    <footer className="safe-bottom relative z-10 border-t border-border bg-background/80 py-8 backdrop-blur-md sm:py-10">
      <div className="section-inner flex flex-col gap-6">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav aria-label="Footer" className="hidden flex-wrap items-center justify-center gap-x-4 gap-y-2 md:flex">
            {navLinks.map((link) => (
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="footer-link rounded-lg border border-border p-2.5"
              aria-label="Email"
            >
            ...
            <a
              href="#home"
              className="footer-link rounded-lg border border-primary/30 p-2.5 text-primary"
